...
function ingresoSalud(salud, tratamiento) {
    ...
    while (salud < 0 || salud > 100 || salud == " ") {
        salud = Number(prompt("Ingrese un valor valido, entre 0 y 100, para los PS:"));
    }
    if (salud == 100) {
        console.log("Su pokemon esta en perfecto estado, no requiere de nuestros servicios.");
        pokemonSano();
    } else {
        ingresoTratamiento(salud, tratamiento);
    }
}
...
function ingresoTratamiento(salud, tratamiento) {
